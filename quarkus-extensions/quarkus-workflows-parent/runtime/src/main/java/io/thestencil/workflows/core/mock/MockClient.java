...
import io.thestencil.workflows.core.spi.BuilderTemplate;
...
public class MockClient extends BuilderTemplate {
  ...
  public Uni<List<Workflow>> completed() {
  ...
  private Workflow toUserForm(JsonObject entity) {
