package io.thestencil.persistence.web;
...
public abstract class HandlerTemplate implements Handler<RoutingContext> {
  private static final Logger LOGGER = LoggerFactory.getLogger(HandlerTemplate.class);
  ...
  public static void catch404(String id, HandlerContext ctx, HttpServerResponse response) {
  ...
  public static void catch422(Throwable e, HandlerContext ctx, HttpServerResponse response) {
